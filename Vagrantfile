...
Vagrant.configure("2") do |config|
    ...
    kali.vm.provision "shell", privileged: true, inline: <<-SHELL
      ...
      wget -o ransomware_sample.zip --post-data "query=get_file&sha256_hash=15ef2d6ef402a46165be39d9dbc0081cf28ebca0f407306dd80ac3a73a32c07b" https://mb-api.abuse.ch/api/v1/ #This is a real ransomware executable. Leave it alone unless you know what you're doing.
